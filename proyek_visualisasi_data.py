...
mode = st.sidebar.radio("\U0001F319 Pilih Mode Tampilan:", ["Light Mode", "Dark Mode"])

opsi = st.sidebar.radio(
    "\U0001F4CA Pilih halaman visualisasi:",
    [
        "Home",
...
# ======== Visualisasi 5 - Pie Chart Gender ========
